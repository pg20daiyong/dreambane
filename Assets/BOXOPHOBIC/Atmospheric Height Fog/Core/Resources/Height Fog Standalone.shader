...
Shader "BOXOPHOBIC/Atmospherics/Height Fog Standalone"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 DepthByVersion226_g973( float3 _731, float3 _741 )
			{
				float3 result = _731;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 break248_g973 = (ase_screenPosNorm).xy;
				float clampDepth227_g973 = SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy );
				...
				float3 _731226_g973 = appendResult239_g973;
				float eyeDepth218_g973 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float4 unityObjectToClipPos224_g973 = TransformWorldToHClip(TransformObjectToWorld(IN.ase_texcoord4.xyz));
				float4 computeScreenPos225_g973 = ComputeScreenPos( unityObjectToClipPos224_g973 );
				float3 _741226_g973 = ( _WorldSpaceCameraPos - ( eyeDepth218_g973 * ( ( _WorldSpaceCameraPos - WorldPosition ) / computeScreenPos225_g973.w ) ) );
				float3 localDepthByVersion226_g973 = DepthByVersion226_g973( _731226_g973 , _741226_g973 );
				float3 WorldPositionFromDepth253_g973 = localDepthByVersion226_g973;
				float3 WorldPosition2_g973 = WorldPositionFromDepth253_g973;
				float temp_output_7_0_g976 = _FogDistanceStart;
				half FogDistanceMask12_g973 = pow( abs( saturate( ( ( distance( WorldPosition2_g973 , _WorldSpaceCameraPos ) - temp_output_7_0_g976 ) / ( _FogDistanceEnd - temp_output_7_0_g976 ) ) ) ) , _FogDistanceFalloff );
				...
				#endif
				float3 temp_output_2_0_g975 = staticSwitch442_g973;
				float3 gammaToLinear3_g975 = FastSRGBToLinear( temp_output_2_0_g975 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g975 = temp_output_2_0_g975;
				#else
				float3 staticSwitch1_g975 = gammaToLinear3_g975;
				#endif
				float3 temp_output_256_0_g973 = staticSwitch1_g975;
				
				half3 AHF_FogAxisOption181_g973 = _FogAxisOption;
				float3 break159_g973 = ( WorldPosition2_g973 * AHF_FogAxisOption181_g973 );
				float temp_output_7_0_g977 = _FogHeightEnd;
				half FogHeightMask16_g973 = pow( abs( saturate( ( ( ( break159_g973.x + break159_g973.y + break159_g973.z ) - temp_output_7_0_g977 ) / ( _FogHeightStart - temp_output_7_0_g977 ) ) ) ) , _FogHeightFalloff );
				...
				float3 p1_g979 = temp_output_197_0_g973;
				float localSimpleNoise3D1_g979 = SimpleNoise3D( p1_g979 );
				float temp_output_7_0_g978 = _NoiseDistanceEnd;
				half NoiseDistanceMask7_g973 = saturate( ( ( distance( WorldPosition2_g973 , _WorldSpaceCameraPos ) - temp_output_7_0_g978 ) / ( 0.0 - temp_output_7_0_g978 ) ) );
				float lerpResult198_g973 = lerp( 1.0 , (localSimpleNoise3D1_g979*0.5 + 0.5) , ( NoiseDistanceMask7_g973 * _NoiseIntensity ));
				...
				float temp_output_7_0_g974 = _SkyboxFogHeight;
				float saferPower309_g973 = max( abs( saturate( ( ( abs( ( break170_g973.x + break170_g973.y + break170_g973.z ) ) - temp_output_7_0_g974 ) / ( 0.0 - temp_output_7_0_g974 ) ) ) ) , 0.0001 );
				...
				float clampDepth118_g973 = SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy );
				#ifdef UNITY_REVERSED_Z
				...
				float3 Color = temp_output_256_0_g973;
				float Alpha = temp_output_43_0_g973;
...
Node;AmplifyShaderEditor.FunctionNode;1119;-3328,-4608;Inherit;False;Base;1;;973;13c50910e5b86de4097e1181ba121e0e;26,343,1,388,1,351,1,354,1,116,1,366,1,345,1,364,1,360,1,339,1,384,1,99,1,386,1,349,1,355,1,392,1,372,1,347,1,370,1,382,1,361,1,374,1,376,1,368,1,380,1,378,1;0;4;FLOAT4;113;FLOAT3;86;FLOAT;87;FLOAT;445
...
WireConnection;1121;2;1119;86
WireConnection;1121;3;1119;87
WireConnection;1121;5;1119;445
ASEEND*/
//CHKSM=01147773CCE5259AEAA212F8FD9C89CC131F4407
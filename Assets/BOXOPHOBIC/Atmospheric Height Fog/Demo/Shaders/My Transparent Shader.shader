	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 gammaToLinear3_g916 = FastSRGBToLinear( temp_output_2_0_g916 );
				...
				float3 temp_output_95_86_g681 = temp_output_256_0_g914;
				half3 AHF_FogAxisOption181_g914 = AHF_FogAxisOption;
				float3 break159_g914 = ( WorldPosition2_g914 * AHF_FogAxisOption181_g914 );
				float temp_output_7_0_g918 = AHF_FogHeightEnd;
				half FogHeightMask16_g914 = pow( abs( saturate( ( ( ( break159_g914.x + break159_g914.y + break159_g914.z ) - temp_output_7_0_g918 ) / ( AHF_FogHeightStart - temp_output_7_0_g918 ) ) ) ) , AHF_FogHeightFalloff );
				...
				half NoiseDistanceMask7_g914 = saturate( ( ( distance( WorldPosition2_g914 , _WorldSpaceCameraPos ) - temp_output_7_0_g919 ) / ( 0.0 - temp_output_7_0_g919 ) ) );
				...
				float temp_output_95_87_g681 = temp_output_43_0_g914;
				float3 lerpResult82_g681 = lerp( float3( 0,0,0 ) , temp_output_95_86_g681 , temp_output_95_87_g681);
...
/*ASEBEGIN
Version=18801
1920;13;1906;1009;1356.867;-202.2366;2.007765;True;False
...
Node;AmplifyShaderEditor.FunctionNode;78;1408,1056;Inherit;False;Apply Height Fog;0;;681;950890317d4f36a48a68d150cdab0168;0;1;81;FLOAT3;0,0,0;False;3;FLOAT3;85;FLOAT3;86;FLOAT;87
...
ASEEND*/
//CHKSM=29176C42029A99FA684E8E48BEA20A210FDF44BA
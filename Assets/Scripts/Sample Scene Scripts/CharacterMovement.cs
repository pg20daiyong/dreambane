...
public abstract class CharacterMovement : MonoBehaviour
{
    ...
    [SerializeField] protected Transform _turnTransform;
    [Header("Airborne")]
    ...
    protected virtual void FixedUpdate()
    {
        ...
        if (_controlRotation && (IsGrounded || _airTurning))
        {
            ...
            Quaternion lookRotation = Quaternion.Slerp(transform.rotation, targetRotation, Time.fixedDeltaTime * _turnSpeed);
            Quaternion rotation = Quaternion.Slerp(transform.rotation, targetRotation, Time.fixedDeltaTime * _turnSpeed * .5f);
    ...
    {
        //if (!GameMgr.instance.GameRunning) return Vector3.zero;
